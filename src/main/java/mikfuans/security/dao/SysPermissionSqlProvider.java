...
public class SysPermissionSqlProvider {
    ...
    public String countByExample(SysPermissionCriteria example) {
        SQL sql = new SQL();
    ...
    public String deleteByExample(SysPermissionCriteria example) {
        SQL sql = new SQL();
    ...
    public String selectByExample(SysPermissionCriteria example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        SysPermissionCriteria example = (SysPermissionCriteria) parameter.get("example");
    ...
    protected void applyWhere(SQL sql, SysPermissionCriteria example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
        ...
        List<SysPermissionCriteria.Criteria> oredCriteria = example.getOredCriteria();
        boolean firstCriteria = true;
        for (int i = 0; i < oredCriteria.size(); i++) {
            SysPermissionCriteria.Criteria criteria = oredCriteria.get(i);
            if (criteria.isValid()) {
                if (firstCriteria) {
                    firstCriteria = false;
                } else {
                ...
                sb.append('(');
                List<SysPermissionCriteria.Criterion> criterions = criteria.getAllCriteria();
                boolean firstCriterion = true;
                for (int j = 0; j < criterions.size(); j++) {
                    SysPermissionCriteria.Criterion criterion = criterions.get(j);
                    if (firstCriterion) {
